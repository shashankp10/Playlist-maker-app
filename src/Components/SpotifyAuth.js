...
import '../Stylesheets/SpotifyAuth.css';


const CLIENT_ID = '300afc452e364634b226c94cb7401877';
const REDIRECT_URI = 'http://localhost:3000';   // https://playlist-maker-woad.vercel.app/redirect
...
const SpotifyAuth = ({ onAccessToken }) => {
  ...
  return (
    <div className='auth'>
      ...
      <p>This application allows you to convert your favorite YouTube playlist into a Spotify playlist within few clicks...<br/> Want to see how it works? <br/>Click below to log in with Spotify.</p>
      {!token ? (
        <a
          className='authBtn' 
